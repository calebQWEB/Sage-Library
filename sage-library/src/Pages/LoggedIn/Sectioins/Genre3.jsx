...
const Genre3 = () => {
  ...
  return (
    <section className="section-padding">
      <div className="loggedIn__genre-3-header-container">
        <h1 className="loggedIn__genre-3-header">You like Self-Help</h1>
      </div>
      <Slider {...settings} className="loggedIn__genre-3-books">
        {data.items.map((item) => {
          return (
            <div key={uuidv4()}>
              <Books
